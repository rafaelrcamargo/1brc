...
pub const CITIES: [(&str, f32); 447] = [
    ...
    ("San José", 22.6),
    ("San Juan", 17.9),
    ("San Miguel de Tucumán", 19.5),
    ("San Salvador", 23.1),
    ("Sana'a", 20.0),
    ("Santa Cruz de la Sierra", 24.8),
    ("Santiago", 14.7),
    ("Santiago del Estero", 20.4),
    ("Santo Domingo", 25.9),
    ("São Joaquim", 13.3),
    ("São Paulo", 19.2),
    ("Sapporo", 8.9),
